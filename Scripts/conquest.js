...
/*
 * Display Seeking Coordinates
 */
const seekingLat = document.getElementById("seekingLat");
const seekingLon = document.getElementById("seekingLon");

map.on("move", function (e) {
  var seekingLatLon = crosshair.getLatLng();

  seekingLat.innerHTML = `${seekingLatLon.lat.toFixed(4)}&deg;,`;
  seekingLon.innerHTML = `${seekingLatLon.lng.toFixed(4)}&deg;`;
});
